export default function EnvyJetSharedFlightEmail() {
  return (
    <div className="min-h-screen bg-gray-100 flex justify-center py-10 px-4 text-sm text-gray-800">
      <div className="w-full max-w-3xl bg-white border border-gray-200">
        ...
        <div className="px-8 py-8 space-y-4">
          ...
          <p>
            Thank you, we have received your request to book <strong>2</strong> seat(s) on a shared flight
          </p>
          ...
          <p className="font-semibold pt-4">Requested Flight Details:</p>
